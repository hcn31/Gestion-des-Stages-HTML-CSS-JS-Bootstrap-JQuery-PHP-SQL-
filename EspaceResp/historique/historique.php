...
if($_SERVER['REQUEST_METHOD']=='POST') 
{
 ...
 $req="SELECT * FROM entreprise,stage WHERE entreprise.ID=stage.ID and stage.RAPPORT IS NOT NULL AND stage.CONTRAT IS NOT NULL and stage.CNE in (SELECT stage.CNE FROM stage,appartient WHERE stage.CNE=appartient.CNE and appartient.NIVEAU in (SELECT NIVEAU FROM NIVEAU  WHERE ID_FORMATION='$f'))";
...
<?php  foreach($row as $V): 
    ...
    ?>                 
                        ...
                        <tbody>
                             <tr>
                            <td width="40px">
                                <div class="imgBx"><img src="../../EspaceEtu/img/LOGOENTRE/<?php echo $V['LOGO']?>" alt=""></div>
                            </td>
                                <td>
                                   <div class="ms-3">
